...
sudo mkdir /dokemondata-server

# Run Dokemon
sudo docker run -p 9090:9090 \\
      -v /dokemondata-server:/data \\
  ...
  return (
    <>
      <main className="flex min-h-screen flex-col items-center pt-24 pb-8 px-8 text-gray-300">
        ...
        <div className="mb-10">
          <iframe
            src="https://ghbtns.com/github-btn.html?user=javastraat&repo=dokemon&type=star&count=true&size=large"
            width="128"
            height="30"
            title="GitHub"
          ></iframe>
        ...
        <div className="mb-12">
          <a
            ...
            href="https://github.com/javastraat/dokemon/wiki"
            target="_blank"
          >
        ...
        <ul className="flex gap-10">
          ...
          <li>
            <a
              className="flex items-center gap-2 text-sm"
              href="https://github.com/javastraat/dokemon/issues"
              target="_blank"
            >
              <FontAwesomeIcon
                icon={faGithub}
